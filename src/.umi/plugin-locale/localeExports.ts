...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'F:/work/client/src/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'F:/work/client/src/node_modules/warning/warning.js';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('F:/work/client/src/src/locales/en-US.ts')),
    },
    locale: 'en-US',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('F:/work/client/src/src/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
